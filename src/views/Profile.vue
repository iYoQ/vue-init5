                ...
                <div class="left-ads-display col-lg-10">
                    <div class="row">
                        <div v-if="showInfo" class="desc1-right col-md-11 pl-lg-4">
                            ...
                            <ul class="pl-3 pt-3">
                                <li class="li-user"><span class="span-user">День рождения:</span> {{ new Date(user.birth_date).toDateString() }}</li>
                                <li class="li-user"><span class="span-user">Дата регистрации:</span> {{ new Date(user.date_registration).toDateString() }}</li>
                                <li class="li-user"><span class="span-user">Заходил:</span> {{ new Date(user.last_login).toDateString() }}</li>
                                <li class="li-user"><span class="span-user">Пол:</span> {{ user.gender }}</li>
                                <li class="li-user"><span class="span-user">Рейтинг:</span> {{ user.rating }}</li>
                                <li class="li-user"><span class="span-user">Постов:</span> {{ user.post_count}}</li>
                                <li class="li-user"><span class="span-user">Комментариев:</span> {{ user.comments_count }}</li>
...
export default {
    ...
    name: "Profile",
    props: ['username'],
    components: { RecComment, Pagination, UpdateProfile },
    data() {
        return {
            user: {},
            comments: [],
